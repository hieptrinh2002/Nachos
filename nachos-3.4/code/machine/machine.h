...
public:
	...
	char *User2System(int virtAddr, int limit);			  // copy data from user space to kernel space
	int System2User(int virtAddr, int len, char *buffer); // copy data from kernel space to user space
